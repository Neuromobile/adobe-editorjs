! function(AV, window, document) {
    AV.build = {
        ...
        version: "4.3.1",
        bundled: !1,
        feather_baseURL: "http://feather.aviary.com/csdk/4.3.1.34/",
        feather_baseURL_SSL: "https://dme0ih8comzn4.cloudfront.net/csdk/4.3.1.34/",
    ...
    function() {
        ...
        "function" != typeof AV.JSON.stringify && (AV.JSON.stringify = function(e, t, a) {
            ...
            else "string" == typeof a && (indent = a); if (rep = t, t && "function" != typeof t && ("object" != typeof t || "number" != typeof t.length)) throw new Error("AV.JSON.stringify");
            return str("", {
                "": e
            })
